...
class _EnchantObject(object):
    ...
    def _init_this(self):
        """Initialize the underlying C-library object pointer."""
...
class Broker(_EnchantObject):
    ...
    def _init_this(self):
        ...
        if not self._this:
            raise Error("Could not initialize an enchant broker.")
        self._live_dicts = {}
...
class Dict(_EnchantObject):
    ...
    def __init__(self,tag=None,broker=None):
        ...
        is used.
        """
        # Initialize misc object attributes to None
        self.provider = None
        ...
        if broker is None:
            broker = _broker
        self._broker = broker
        # Now let the superclass initialize the C-library object
        _EnchantObject.__init__(self)
