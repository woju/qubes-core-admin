...
class QubesVmStorage(object):
    ...
    def _get_disk_usage(self, file_or_dir):
        """
        Calculate real disk usage of file/directory
        """
    ...
    def get_disk_utilization(self):
        return self._get_disk_usage(self.vmdir)

    def get_disk_utilization_private_img(self):
        return self._get_disk_usage(self.private_img)
