...
class QubesVm(object):
    ...
    def get_attrs_config(self):
        ...
        attrs['maxmem']['save_skip'] = 'self.maxmem is None'
        attrs['vcpus']['save_skip'] = 'self.vcpus is None'
    ...
    def get_disk_utilization(self):
        return self.storage.get_disk_utilization()

    def get_disk_utilization_private_img(self):
        return self.storage.get_disk_utilization_private_img()
    ...
    def write_firewall_conf(self, conf):
        ...
        try:
            old_umask = os.umask(002)
            with LockFile(self.firewall_conf):
