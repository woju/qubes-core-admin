...
class TC_20_Policy(qubes.tests.QubesTestCase):
    ...
    def test_030_eval_simple(self):
        ...
        policy = qubespolicy.Policy('test.service')
        action = policy.eval(system_info, 'test-vm1', 'test-vm2')
        ...
        with self.assertRaises(qubespolicy.AccessDenied):
            policy.eval(system_info, 'test-vm2', '$default')
    ...
    def test_031_eval_default(self):
        ...
        policy = qubespolicy.Policy('test.service')
        action = policy.eval(system_info, 'test-vm1', '$default')
        ...
        with self.assertRaises(qubespolicy.AccessDenied):
            ...
            # caller or policy)
            policy.eval(system_info, 'test-standalone', '$default')
    ...
    def test_032_eval_ask(self):
        ...
        policy = qubespolicy.Policy('test.service')
        action = policy.eval(system_info, 'test-standalone', 'test-vm2')
    ...
    def test_033_eval_ask(self):
        ...
        policy = qubespolicy.Policy('test.service')
        action = policy.eval(system_info, 'test-standalone', 'test-vm3')
